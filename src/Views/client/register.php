...
<main class="bg-gradient-to-br from-orange-50 via-white to-pink-50 flex items-center justify-center px-4 py-4 sm:py-8 min-h-screen absolute top-0 left-0 right-0 bottom-0 overflow-auto">
  ...
  <div class="w-full max-w-sm md:max-w-md relative z-10 my-auto">
    ...
    <div class="text-center mb-3 sm:mb-6">
      <h1 class="text-xl sm:text-2xl md:text-3xl font-bold bg-gradient-to-r from-red-500 to-pink-500 accent-gradient accent-text-gradient bg-clip-text text-transparent mb-1 sm:mb-2">
    ...
    <div class="bg-white rounded-3xl shadow-2xl p-4 sm:p-6 md:p-8 backdrop-blur-sm">
      <form id="registerForm" action="/register" method="post" class="space-y-3 sm:space-y-4">
        ...
        <button
          type="submit"
          class="w-full bg-gradient-to-r from-red-500 to-pink-500 accent-gradient text-white font-semibold py-2.5 sm:py-3 md:py-4 rounded-2xl hover:shadow-lg hover:scale-[1.02] transition-all text-sm sm:text-base md:text-lg flex items-center justify-center space-x-2 sm:space-x-3 relative overflow-hidden group mt-4 sm:mt-6"
        >
