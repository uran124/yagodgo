...
return [
    static function (string $method, string $uri, array $c): bool {
        $map = [
            ...
            'GET /partner/production' => ['App\\Controllers\\ProductionController', 'index'],
            ...
            'GET /partner/delivery/address-suggestions' => ['App\\Controllers\\DeliveryController', 'addressSuggestions'],
